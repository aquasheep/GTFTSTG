...
public class GTFTSTG extends Game {
	...
	public void create() {
		...
		items[0] = new Bottle(this,(int)(0.2965*screenWidth),(int)(0.3609*screenHeight));
		items[1] = new Clown(this,(int)(0.5098*screenWidth),(int)(0.3311*screenHeight));
		items[2] = new ActionFigure(this,(int)(0.5499*screenWidth),(int)(0.1669*screenHeight));
		...
		items[5] = new Phone(this,(int)(0.3425*screenWidth),(int)(0.3789*screenHeight));
		items[6] = new Camera(this,(int)(0.6115*screenWidth),(int)(0.6621*screenHeight));
		items[7] = new Keys(this,(int)(0.8190*screenWidth),(int)(0.0095*screenHeight));
		items[8] = new Rattle(this,(int)(0.3425*screenWidth),(int)(0.0176*screenHeight));
		items[9] = new Pacifier(this,(int)(0.3503*screenWidth),(int)(0.2700*screenHeight));
	}
