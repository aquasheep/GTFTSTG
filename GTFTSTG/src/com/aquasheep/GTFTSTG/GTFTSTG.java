...
public class GTFTSTG extends Game {
	...
	public void create() {
		...
		items[0] = new Bottle(this,(int)(0.2965*screenWidth),(int)(0.3359*screenHeight));
		...
		items[6] = new Camera(this,(int)(0.6115*screenWidth),(int)(0.6421*screenHeight));
		items[7] = new Keys(this,(int)(0.8190*screenWidth),(int)(0.0345*screenHeight));
		items[8] = new Rattle(this,(int)(0.3425*screenWidth),(int)(0.0176*screenHeight));
		items[9] = new Pacifier(this,(int)(0.3503*screenWidth),(int)(0.2900*screenHeight));
	}
